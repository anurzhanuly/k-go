...
* Рекомендую изучить библиотеку `https://github.com/pkg/errors`. При создании ошибок через эту библиотеку она добавляет к ошибке стектрейс (как это делают исключения в PHP). При логировании таких ошибок в логах мы увидим больше полезной информации.
